...
Task3_PBI.pbix
The main Power BI Desktop project file containing the dataset, transformations, visualizations, and dashboard.

README.md
Documentation of the project.

screenshots/
Contains screenshots of the Power BI dashboard and its visualizations.
...
3. Open the "Task3_PBI.pbix" file.
4. Wait for the data and visuals to load.
...
«Note: Make sure the screenshot file names in the README match the actual names of your image files.»
